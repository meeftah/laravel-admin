...
class CreateTblCasisSmpTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_casis_smp', function (Blueprint $table) {
            $table->uuid('id_casis_smp')->primary();
            $table->uuid('id_user');
            $table->uuid('id_va_smp');
            ...
            $table->uuid('id_dokumen_smp')->nullable();
            ...
            $table->foreign('id_va_smp')
                ->references('id_va_smp')
                ->on('tbl_va_smp')
                ->onDelete('cascade')
                ->onUpdate('cascade');
            ...
            $table->foreign('id_dokumen_smp')
                ->references('id_dokumen_smp')
                ->on('tbl_dokumensmp')
                ->onDelete('cascade')
                ->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('tbl_casis_smp');
    }
}
