...
class CasisSmaController extends Controller
{
    ...
    {
        // ambil semua data
        $casissma = CasisSma::orderBy('created_at', 'ASC')->get();
            ...
            ->addColumn(
                ...
                function ($row) {
                    ...
                    if (auth()->user()->can('casissma_detail')) {
                        $btn   .= '<a href="' . route('dashboard.casissma.show', $row['id_casis_sma']) . '" class="btn btn-primary btn-sm" title="DETAIL"><i class="fa fa-eye"></i></a> ';
                    }
                    if (auth()->user()->can('casissma_ubah')) {
                        $btn   .= '<a href="' . route('dashboard.casissma.edit', $row['id_casis_sma']) . '" class="btn btn-warning btn-sm" title="UBAH"><i class="fa fa-pencil"></i></a> ';
                    }
    ...
    public function index()
    {
        ...
        return view('dashboard.casis.sma.index');
    }
