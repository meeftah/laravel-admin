...
class CasisSd extends Model
{
    ...
    protected $fillable = [
        ...
        'rw_asal',
        'kodepos_asal',
        'kode_provinsi_sekarang',
        'kode_kabkota_sekarang',
        'kode_kecamatan_sekarang',
        'kode_desalurah_sekarang',
        'alamat_sekarang',
        'rt_sekarang',
        'rw_sekarang',
        'kodepos_sekarang',
    ...
    {
        $result = CasisSd::where('id_status_casis', StatusCasis::getDataByNama(config('ppdb.status.calon_siswa.siaptes'))->id_status_casis)->get();
        return $result;
    }
}
