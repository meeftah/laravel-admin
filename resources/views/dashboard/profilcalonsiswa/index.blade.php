                            ...
                            <div class="">
                                <div class="form-group row align-items-center mb-0">
                                    ...
                                    <div class="col-md-9 pb-2 pt-2">
                                        <input type="text" id="nm_siswa" name="nm_siswa" class="form-control" placeholder="NAMA LENGKAP"
                                ...
                                <div class="form-group row align-items-center mb-0">
                                    ...
                                    <div class="col-md-9 pb-2 pt-2">
                                        <input type="text" id="nik" name="nik" class="form-control" maxlength="10" value=""
                                ...
                                <div class="form-group row align-items-center mb-0">
                                    ...
                                    <div class="col-sm-12 col-md-9 pb-2 pt-2">
                                        <select name="id_agama" class="form-control select2-show-search"
                                ...
                                <hr>
                                <div class="form-group row align-items-center mb-0">
                                    <label class="col-sm-12 col-md-3 control-label col-form-label"></label>
                                    <div class="col-sm-12 col-md-9 pb-2 pt-2">
                                        ALAMAT SEKARANG
                                ...
                                <div class="form-group row align-items-center mb-0">
                                    ...
                                    <div class="col-sm-12 col-md-9 pb-2 pt-2">
                                        <select name="id_jarak" class="form-control select2-show-search"
                                ...
                                <div class="form-group row align-items-center mb-0">
                                    ...
                                    <div class="col-sm-12 col-md-9 pb-2 pt-2">
                                        <input type="text" class="form-control" value="" placeholder="(0561) 88888888">
                                    </div>
                                </div>
                                <div class="form-group row align-items-center mb-0">
                                    <label class="col-sm-12 col-md-3 control-label col-form-label">
                                ...
                                <div class="form-group row align-items-center mb-0">
                                    ...
                                    <div class="col-sm-12 col-md-9 pb-2 pt-2">
                                        <select name="id_bcquran" class="form-control select2-show-search"
                                            data-placeholder="PILIH KEMAMPUAN MEMBACA QURAN">
                                            <option></option>
