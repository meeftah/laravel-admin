...
@section('title', 'Daftar Data Tempat Tinggal Saat Ini')

@section('breadcrumb')
<div class="br-pageheader pd-y-15 pd-l-20">
    <nav class="breadcrumb pd-0 mg-0 tx-12">
        <a class="breadcrumb-item" href="{{ route('dashboard.tempattinggal.index') }}">Data Tempat Tinggal Saat Ini</a>
    </nav>
</div>
@endsection
...
<div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
    <h4 class="tx-gray-800 mg-b-5">Data Tempat Tinggal Saat Ini</h4>
    <p class="mg-b-0">Master Data Tempat Tinggal Saat Ini</p>
</div>
@endsection
...
<div class="row">
    <div class="col-sm-12 col-md-4 mb-5">
        <div class="card">
            <div class="card-body">
                <form action="{{ route("dashboard.tempattinggal.store") }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        <label class="form-control-label">tempattinggal: <span class="tx-danger">*</span></label>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered dt-responsive nowrap" data-form="deleteForm"
                        style="border-collapse: collapse; border-spacing: 0; width: 100%;" id="datatable-tempattinggal">
                        <thead>
                            <tr class="text-uppercase">
                                ...
                                @if(auth()->user()->can('tempattinggal_detail') || auth()->user()->can('tempattinggal_ubah')
                                ||
                                auth()->user()->can('tempattinggal_hapus'))
...
<script>
    $(document).ready( function () {
        $('#datatable-tempattinggal').DataTable({
            responsive: true,
            processing: true,
            serverSide: true,
            language: {
            ...
            ajax: "{{ route('dashboard.tempattinggal.api') }}",
            columns: [
                { data: 'id_tempattinggal', name: 'id_tempattinggal', visible: false },
                { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable:false, serachable:false },
                { data: 'kode', name: 'kode' },
                { data: 'tempattinggal', name: 'tempattinggal' },
                @if(auth()->user()->can('tempattinggal_detail') || auth()->user()->can('tempattinggal_ubah') || auth()->user()->can('tempattinggal_hapus'))
    ...
    $('#delete-btn').click(function(){
        $.ajax({
            ...
            success:function(data){
                ...
                $('#datatable-tempattinggal').DataTable().ajax.reload();
