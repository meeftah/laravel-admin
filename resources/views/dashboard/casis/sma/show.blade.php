...
@section('title', 'Detail Calon Siswa SMA')

@section('breadcrumb')
<div class="br-pageheader pd-y-15 pd-l-20">
    <nav class="breadcrumb pd-0 mg-0 tx-12">
        <a class="breadcrumb-item" href="{{ route('dashboard.calon-siswa.sma.index') }}">Data Siswa SMAIT</a>
        <a class="breadcrumb-item" href="javascript: void(0);">Detail Calon Siswa SMAIT</a>
    </nav>
</div>
@endsection
...
<div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
    <h4 class="tx-gray-800 mg-b-5">Detail Calon Siswa SMAIT</h4>
</div>
@endsection
                        ...
                        <div class="form-group row align-items-center mb-0">
                            ...
                            <div class="col-md-9 pb-2 pt-2">
                                <input type="text" class="form-control"
                                    value="{{ App\Models\VaSma::getDataById($casis->id_va_sma)->va ?? '-' }}" disabled>
                            </div>
                        </div>
