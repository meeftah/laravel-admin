...
@section('title', 'Detail Calon Siswa SMP')

@section('breadcrumb')
<div class="br-pageheader pd-y-15 pd-l-20">
    <nav class="breadcrumb pd-0 mg-0 tx-12">
        <a class="breadcrumb-item" href="{{ route('dashboard.calon-siswa.smp.index') }}">Data Siswa SMPIT</a>
        <a class="breadcrumb-item" href="javascript: void(0);">Detail Calon Siswa SMPIT</a>
    </nav>
</div>
@endsection
...
<div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
    <h4 class="tx-gray-800 mg-b-5">Detail Calon Siswa SMPIT</h4>
</div>
@endsection
...
<div class="br-profile-page">
    <div class="card shadow-base bd-0 rounded-0 widget-4">
        <div class="card-body text-white" style="padding-top: 40px">
            ...
            <h4 class="tx-normal tx-roboto tx-white" style="margin-top: 30px">
                {{ $casis->nm_siswa ? strtoupper($casis->nm_siswa) : App\Models\User::getDataById($casis->id_user)->username }}
            </h4>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active show" id="biodata">
                        <div class="form-group row align-items-center mb-0">
                            ...
                            <div class="col-md-9 pb-2 pt-2">
                                <input type="text" class="form-control"
                                    value="{{ App\Models\VaSmp::getDataById($casis->id_va_smp)->va ?? '-' }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-group row align-items-center mb-0">
                            ...
                            <div class="col-md-9 pb-2 pt-2">
                                <input type="text" class="form-control" value="{{ $casis->asal_sekolah ?? '-' }}" disabled>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="dokumen">
                        ...
                        <hr>
                        <div class="mt-4">
                            <h4 class="card-title">Raport Kelas 5</h4>
                            <h6 class="card-subtitle text-dark">
                                Scan raport kelas 5 smester 1
                            </h6>
                            <div style="margin-top: 10px">
                                <a href="{{ $casis->kelas5semester1 ? url('/' . $casis->kelas5semester1) : 'javascript: void(0);' }}"
                                    class="btn btn-primary col-md-3 @if(empty($casis->kelas5semester1)) disabled @endif }}" target="_blank">
                                    LIHAT
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            <h4 class="card-title">Raport Kelas 5</h4>
                            <h6 class="card-subtitle text-dark">
                                Scan raport kelas 5 smester 2
                            </h6>
                            <div style="margin-top: 10px">
                                <a href="{{ $casis->kelas5semester2 ? url('/' . $casis->kelas5semester2) : 'javascript: void(0);' }}"
                                    class="btn btn-primary col-md-3 @if(empty($casis->kelas5semester2)) disabled @endif }}" target="_blank">
                                    LIHAT
                                </a>
                            </div>
                        </div>
                        ...
                        <hr>
                        <div class="mt-4">
                            <h4 class="card-title">Raport Kelas 6</h4>
                            <h6 class="card-subtitle text-dark">
                                Scan raport kelas 6 smester 1
                            </h6>
                            <div style="margin-top: 10px">
                                <a href="{{ $casis->kelas6semester1 ? url('/' . $casis->kelas6semester1) : 'javascript: void(0);' }}"
                                    class="btn btn-primary col-md-3 @if(empty($casis->kelas6semester1)) disabled @endif }}" target="_blank">
                                    LIHAT
                                </a>
                            </div>
                        </div>
