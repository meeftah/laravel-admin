...
<div class="br-pageheader pd-y-15 pd-l-20">
    <nav class="breadcrumb pd-0 mg-0 tx-12">
        <a class="breadcrumb-item" href="{{ route('dashboard.va.tk.index') }}">Data Virtual Account TKIT</a>
    </nav>
</div>
@endsection
...
<div class="row">
    <div class="col-sm-12 col-md-4 mb-5">
        <div class="card">
            <div class="card-body">
                {{-- <form action="{{ route("dashboard.va.tk.store") }}" method="POST">
                    @csrf
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered dt-responsive nowrap" data-form="deleteForm"
                        style="border-collapse: collapse; border-spacing: 0; width: 100%;" id="datatable-vatk">
                        <thead>
                            <tr class="text-uppercase">
                                ...
                                <th>KODE NAMA VA</th>
                                <th>STATUS</th>
                                @if(auth()->user()->can('vatk_detail') || auth()->user()->can('vatk_ubah')
                                ||
                                auth()->user()->can('vatk_hapus'))
    ...
    $(document).ready( function () {
        $('#datatable-vatk').DataTable({
            ...
            columns: [
                ...
                @if(auth()->user()->can('vatk_detail') || auth()->user()->can('vatk_ubah') || auth()->user()->can('vatk_hapus'))
    ...
    $('#delete-btn').click(function(){
        $.ajax({
            ...
            success:function(data){
                ...
                $('#datatable-vatk').DataTable().ajax.reload();
