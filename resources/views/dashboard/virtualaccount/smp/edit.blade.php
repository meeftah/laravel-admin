...
<div class="br-pageheader pd-y-15 pd-l-20">
    <nav class="breadcrumb pd-0 mg-0 tx-12">
        <a class="breadcrumb-item" href="{{ route('dashboard.va.smp.index') }}">Virtual Account SMPIT</a>
...
<div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
    ...
    <p class="mg-b-0">Ubah data Virtual Account SMPIT {{ $vasmp->va }}</p>
</div>
@endsection
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('va') ? 'is-invalid' : '' }}" type="text"
                            name="va" placeholder="Masukkan VA" value="{{ old('va', $vasmp->va) }}">
                        @error('va')
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('kode_nama') ? 'is-invalid' : '' }}" type="text"
                            name="kode_nama" placeholder="Masukkan kode_nama" value="{{ old('kode_nama', $vasmp->kode_nama) }}">
                        @error('kode_nama')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="text"
                            name="status" placeholder="Masukkan data status" value="{{ old('status', $vasmp->status) }}">
                        @error('status')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
